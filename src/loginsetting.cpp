...
void loginsetting::slot_autoLoad() {
  if (m_bIsConnect) {
    ConnectMaster();
  }
}
void loginsetting::slot_writeSettings() {
  QSettings main_setting("rosqt_gui", "settings");
  ...
  QSettings settings("rosqt_gui", "Displays");
...
void loginsetting::changeEvent(QEvent *e) {
...
void loginsetting::readSettings() {
  QSettings settings("rosqt_gui", "Displays");
  ...
  QSettings connect_info("rosqt_gui", "connect_info");
...
/**
 * @brief loginsetting::on_btnLogin_clicked
 * 用户登陆
 */
void loginsetting::on_btnLogin_clicked() {
...
void loginsetting::ConnectMaster() {
  int argc;
  char **argv;
  if (mainWindow != NULL) {
    mainWindow->close();
  }
  mainWindow = new rosqt_gui::MainWindow(argc, argv);
...
void loginsetting::slot_ShowWindow() {
  this->show();
...
void loginsetting::SltAnimationFinished() {}

/**
 * @brief loginsetting::SltEditFinished
 * 编辑完成
 */
void loginsetting::SltEditFinished() {
...
/**
 * @brief loginsetting::InitWidget
 * 界面初始化
 */
void loginsetting::InitWidget() {
  ui->stackedWidget->setCurrentIndex(0);
  // header
  ...
  //设置图标
  Grid->setIcon(0, QIcon(":/images/rviz_images/Grid.png"));
  // checkbox
  ...
  //设置图标
  TF->setIcon(0, QIcon(":/images/rviz_images/TF.png"));
  // checkbox
  ...
  //设置图标
  LaserScan->setIcon(0, QIcon(":/images/rviz_images/LaserScan.png"));
  // checkbox
  ...
  //设置图标
  Polygon->setIcon(0, QIcon(":/images/rviz_images/Polygon.png"));
  ...
  //设置图标
  RobotModel->setIcon(0, QIcon(":/images/rviz_images/RobotModel.png"));
  // checkbox
...
void loginsetting::paintEvent(QPaintEvent *) {
  QPainter painter;
  painter.fillRect(this->rect(), Qt::transparent);
}

// 自动登陆
void loginsetting::on_checkBoxAutoLogin_clicked(bool checked) {}
